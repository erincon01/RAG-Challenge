...
from python.module_postgres import load_matches_data_into_postgres_from_folder, load_lineups_data_into_postgres, load_events_data_into_postgres
from python.module_postgres import copy_data_from_postgres_to_azure, download_match_script
from module_azureopenai import get_tokens_statistics_from_table_column, create_events_summary_from_json_rows_in_database
...
if __name__ == "__main__":
    ...
    # 6) convert each json_ row into a prose script (line by line)
    ...
    create_events_summary_from_json_rows_in_database ("final_match_Spain_England_events_details__minutewise", 3943043, system_message, 0.1, 7500)
    ...
    summary = create_match_summary ("final_match_Spain_England_events_details__minutewise", match_id, system_message, 0.1, 15000)
    print(summary)
