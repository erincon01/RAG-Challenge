...
declare @morata_position VECTOR = '[45, 30]';
SELECT 
    dbo.VECTOR_DISTANCE('euclidean', position, @morata_position),
    dbo.VECTOR_DISTANCE('cosine', position, @morata_position),
    dbo.VECTOR_DISTANCE('dot', position, @morata_position),
    player_name
    from player_positions
